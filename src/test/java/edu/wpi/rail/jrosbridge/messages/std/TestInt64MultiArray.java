...
public class TestInt64MultiArray {

	private Int64MultiArray empty, a1;

	@Before
	public void setUp() {
		empty = new Int64MultiArray();
		a1 = new Int64MultiArray(new MultiArrayLayout(
	...
	public void testConstructor() {
		...
		assertEquals(0,
				empty.toJsonObject().getJsonArray(Int64MultiArray.FIELD_DATA)
						.size());

		assertEquals(Int64MultiArray.TYPE, empty.getMessageType());
	}
	...
	public void testMultiArrayLayoutAndLongArrayConstructor() {
		...
		assertEquals(5l, a1.get(0));
		assertEquals(10l, a1.get(1));
		...
		assertEquals(new MultiArrayLayout(new MultiArrayDimension[] {
				...
				MultiArrayLayout.fromJsonObject(a1.toJsonObject()
						.getJsonObject(Int64MultiArray.FIELD_LAYOUT)));
		assertEquals(2,
				a1.toJsonObject().getJsonArray(Int64MultiArray.FIELD_DATA)
						.size());
		assertEquals(5l,
				a1.toJsonObject().getJsonArray(Int64MultiArray.FIELD_DATA)
						.getJsonNumber(0).longValue());
		assertEquals(10l,
				a1.toJsonObject().getJsonArray(Int64MultiArray.FIELD_DATA)
						.getJsonNumber(1).longValue());

		assertEquals(Int64MultiArray.TYPE, a1.getMessageType());
	}
	...
	public void testClone() {
		Int64MultiArray clone = a1.clone();
	...
	public void testFromJsonString() {
		Int64MultiArray p = Int64MultiArray.fromJsonString(a1.toString());
	...
	public void testFromMessage() {
		...
		Int64MultiArray p = Int64MultiArray.fromMessage(m);
		assertEquals(a1.toString(), p.toString());
		assertEquals(a1.toJsonObject(), p.toJsonObject());
		assertEquals(a1.getMessageType(), p.getMessageType());
		assertEquals(a1.size(), p.size());
	...
	public void testFromJsonObject() {
		...
		JsonObject jsonObject = Json
				.createObjectBuilder()
				.add(Int64MultiArray.FIELD_DATA, array.build())
				.add(Int64MultiArray.FIELD_LAYOUT,
						a1.getLayout().toJsonObject()).build();
		Int64MultiArray p = Int64MultiArray.fromJsonObject(jsonObject);
		assertEquals(a1.toString(), p.toString());
		assertEquals(a1.toJsonObject(), p.toJsonObject());
		assertEquals(a1.getMessageType(), p.getMessageType());
		assertTrue(Arrays.equals(a1.getData(), p.getData()));
	...
	public void testFromJsonObjectNoLayout() {
		...
		JsonObject jsonObject = Json.createObjectBuilder()
				.add(Int64MultiArray.FIELD_DATA, array.build()).build();
		Int64MultiArray p = Int64MultiArray.fromJsonObject(jsonObject);
		assertTrue(Arrays.equals(a1.getData(), p.getData()));
		assertEquals(a1.size(), p.size());
